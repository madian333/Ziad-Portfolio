...
export default function Navigation() {
    ...
    return (
        <>
            ...
            {/* Navigation Panel */}
            <div className={`fixed top-0 right-0 h-full w-64 bg-gradient-to-br from-white to-violet-200 dark:bg-gradient-to-br dark:from-gray-800 dark:to-violet-900 shadow-lg transform transition-transform duration-300 ease-in-out z-40 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
