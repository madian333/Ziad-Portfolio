                ...
                <div className="bg-gradient-to-br from-purple-800 via-blue-800 to-indigo-900 rounded-lg shadow-xl p-6 md:p-8 w-full max-w-lg 
                    ...
                    <div className="space-y-6 text-gray-100">
                        <div className="group">
                            ...
                            <a href="mailto:ali.madian.000@gmail.com" 
                        ...
                        <div className="group">
                            ...
                            <a href="https://www.linkedin.com/in/ali-madian-858933272"
                                target="_blank"
                        ...
                        <div className="group">
                            <h2 className="text-3xl font-semibold text-red-400 mb-2">GitHub</h2>
                            <a href="https://github.com/madian333"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-blue-300 group-hover:text-blue-200 hover:underline text-lg flex items-center transition-colors duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
